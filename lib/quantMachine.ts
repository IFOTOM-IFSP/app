// quantMachine.ts
import { acquireStageVectors, acquireStandards, resampleBurstLinear } from '@/lib/acquisition';
import { MIN_R2, MIN_STANDARDS, validateCalibrationAcceptance, validatePreflight } from '@/lib/quality';
import { computeAStatsFromBursts } from '@/lib/quantCore';
...
import { quantifyHybrid, TARGET_POINTS } from './quantEngine';
  ...
  states: {
    CHOOSE_TYPE: {
      on: {
        SELECT_TYPE: {
          target: 'PARAMS',
          actions: assign({ analysisType: 'quant' as const }),
        },
      },
    },
